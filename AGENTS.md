...
- Work on `agents/*` branches; never push directly to `main`.
- Preserve local-first operation and project isolation.
- Never add transcript capture, hidden telemetry, or silent configuration writes.
